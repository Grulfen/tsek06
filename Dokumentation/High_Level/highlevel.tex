...
reference clock as update signal and the delayed clock signal coming out from the delay cells as input signal (as in figure \ref{fig:phase_det}). If the delayed clock rises before
