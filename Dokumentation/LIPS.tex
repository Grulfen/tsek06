...
\newenvironment{LIPSleveranslista}{%
  \begin{tabular}{|p{40mm}|p{20mm}|p{65mm}|p{15mm}|}
    }%
  {%
    \hline
  \end{tabular}
...
\newcounter{LIPSdeadlinenummer}
\newenvironment{LIPSdeadlines}{%
  \begin{tabular}{|p{4mm}|p{105mm}|p{23mm}|}
    }%
  {%
    \hline
  \end{tabular}
...
\newcommand{\LIPSdeadline}[2]
{\hline
        \stepcounter{LIPSdeadlinenummer}\textbf{\arabic{LIPSdeadlinenummer}} &
        {#1} & 
        \textbf{{#2}} 
\\}
